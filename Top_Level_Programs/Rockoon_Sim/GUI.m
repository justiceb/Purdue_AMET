...
% Last Modified by GUIDE v2.5 22-Aug-2014 20:55:21
...
% Hints: get(hObject,'String') returns contents of rho_PE as text
%        str2double(get(hObject,'String')) returns contents of rho_PE as a double
...
% Hints: get(hObject,'String') returns contents of thickness_PE as text
%        str2double(get(hObject,'String')) returns contents of thickness_PE as a double
...
% --- Executes on button press in creat_balloon.
function creat_balloon_Callback(hObject, eventdata, handles)
% hObject    handle to creat_balloon (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes during object creation, after setting all properties.
function creat_balloon_CreateFcn(hObject, eventdata, handles)
% hObject    handle to creat_balloon (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
